...
FROM            vehicle_categories INNER JOIN
                         vehicles ON vehicle_categories.category_id = vehicles.category_id INNER JOIN
                         models ON vehicles.model_id = models.model_id INNER JOIN
...
FROM            vehicles INNER JOIN
                         models ON vehicles.model_id = models.model_id INNER JOIN
                         vehicle_categories ON vehicles.category_id = vehicle_categories.category_id INNER JOIN
                         bookings ON vehicles.vehicle_id = bookings.vehicle_id INNER JOIN
